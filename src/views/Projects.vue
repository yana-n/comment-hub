...
import AppCommentSection from '@/components/comments/AppCommentSection.vue'

const title = 'A small selection of <span>recent projects</span>'
const text =
...
<template>
  <DefaultLayout class="projects-page" :title :text image-name="projects">
    <app-comment-section />
  </DefaultLayout>
</template>
